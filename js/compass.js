...
function opr360(type, destination, offset) {
  ...
  function compassHeading(event) {
    ...
    navigator.geolocation.getCurrentPosition(function (location) {
      ...
      arrows['up'] = '<i class="fa fa-map-marker fa-5x" aria-hidden="true" style="text-shadow: 2px 2px 4px white;"></i><div style="text-shadow: 2px 2px 4px white;">'+ distanceAway +' mi</div>';
